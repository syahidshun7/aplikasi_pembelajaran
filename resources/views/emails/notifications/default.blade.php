                ...
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:680px;background:#ffffff;border:2px solid #cbd5e1;box-shadow:0 10px 25px rgba(15,23,42,0.12);">
                    ...
                    <tr>
                        <td style="padding:20px 24px 0;">
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:{{ $panelBackground }};border:1px solid {{ $panelBorder }};">
                                <tr>
                                    <td style="padding:14px 14px;color:{{ $panelText }};font-size:12px;line-height:1.7;">
                                        {!! nl2br(e($panelBody)) !!}
                                    </td>
                                </tr>
                            </table>
                    ...
                    <tr>
                        <td align="center" style="padding:22px 24px 8px;">
                            <a href="{{ $actionUrl }}" style="display:inline-block;background:{{ $buttonBackground }};color:{{ $buttonText }};text-decoration:none;font-weight:700;padding:12px 20px;border:2px solid {{ $buttonBorder }};font-family:'Courier New',monospace;font-size:12px;text-transform:uppercase;">
                                {{ $actionLabel }}
                            </a>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding:10px 24px 22px;color:#64748b;font-size:12px;line-height:1.7;">
                            Link manual:
                            <div style="margin-top:6px;word-break:break-all;color:#0ea5e9;">{{ $actionUrl }}</div>
                        </td>
                    </tr>
