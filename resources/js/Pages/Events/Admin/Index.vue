...
<template>
    ...
    <div class="min-h-screen bg-[#0d1117] p-4 md:p-8 font-['Press_Start_2P'] text-[#4ed4d4] text-[10px] relative">
        <div class="max-w-7xl mx-auto space-y-8">
            ...
            <div class="flex justify-between items-center border-b-4 border-blue-900 pb-4">
                <h1 class="text-xl uppercase tracking-widest animate-pulse">Events_Registry_System</h1>
