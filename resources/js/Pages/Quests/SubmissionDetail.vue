<script setup>
import { Head, Link, router } from '@inertiajs/vue3'; // FIXED: Ditambahkan router
...
<template>
    <AuthenticatedLayout>
        <Head :title="'MISSION_REPORT - ' + submission.quest.title" />
            ...
            <div class="grid grid-cols-12 gap-6">
                <div class="col-span-12 lg:col-span-4 space-y-6">
                    ...
                    <div class="rpg-panel" :class="{
                        ...
                        <h2 class="text-white text-[8px] mb-4 border-b border-slate-700 pb-2">MISSION_STATUS</h2>
                ...
                <div class="col-span-12 lg:col-span-8 space-y-6">
                    ...
                    <div class="flex justify-end items-center pt-4">
                        <button v-if="submission.status === 'Rejected'" 
                                @click="router.visit(route('quests.show', submission.quest.uuid))"
                                class="btn-pixel-red px-6 py-3">
                            RE-SUBMIT_MISSION
                        </button>
                    </div>
                </div>
